...
// const initialData = generateGridData(activePeriods);
  ...
  return (
    <Accordion className={css.accwrapper}
     sx={{
          background: "none",
          // color: "inherit",
    ...
    >
      <AccordionSummary expandIcon={<BsCaretDownFill style={{ fill: "var(--white)", }} />} className={css.acctitle}
       style={{
   ...
   padding: "10px",
      ...
      >
        <Typography  style={{
            fontSize: "20px",
            fontWeight: "600",
          }}>Налаштування робочого графіка:</Typography>
      </AccordionSummary> 
