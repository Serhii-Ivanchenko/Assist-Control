...
//   const startOfCalendar = startOfMonth.isoWeekday(1);
//   const endOfCalendar = endOfMonth.isoWeekday(7);
//   const [selectedDate, setSelectedDate] = useState(dayjs());
...
//     if (!isDateDisabled(date)) {
//       setSelectedDate(date); 
//       dispatch(changeActualDate(date.format("YYYY-MM-DD"))); // Оновлюємо дату в Redux
//     }
//   };
